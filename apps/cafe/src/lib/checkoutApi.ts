...
export type CheckoutDraft = {
  ...
  /** Café: dine_in | qr (defaults dine_in). */
  orderChannel?: string;
  tableCode?: string;
};
...
export async function placeStorefrontOrder(params: {
  ...
  const body = {
    ...
    productTypeId: resolveStorefrontProductTypeId(),
    orderChannel: (params.draft.orderChannel ?? "dine_in").trim() || "dine_in",
    tableCode: params.draft.tableCode?.trim() || undefined,
