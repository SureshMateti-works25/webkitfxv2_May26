...
namespace Commerce.Api.Migrations
{
    ...
    [Migration("20260520190502_EnsurePortalUserRoleAssignments")]
    partial class EnsurePortalUserRoleAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commerce.Api.Entities.PortalUserRoleAssignment", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("PortalBaseRole")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
                    ...
                    b.HasIndex("TenantId", "PortalUserId", "IsPrimary");

                    b.HasIndex("TenantId", "PortalUserId", "RoleKey")
                        .IsUnique();

                    b.ToTable("portal_user_role_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Commerce.Api.Entities.TenantCustomRole", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.ToTable("tenant_custom_roles", (string)null);
                });
