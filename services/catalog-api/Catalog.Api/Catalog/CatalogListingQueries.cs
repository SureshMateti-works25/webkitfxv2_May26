...
{
    public static HashSet<string> ResolveCategoryScope(CatalogDbContext db, string tenantId, string? categoryId, bool includeSubtree)
    {
    ...
    public static IQueryable<Product> ApplyFacetFilters(CatalogDbContext db, IQueryable<Product> q, List<(string DefId, string ValueId)> facets)
    {
